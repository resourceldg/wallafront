...
const manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/todos\/([^/]+?)\.json$/,
      params: (m) => ({ uid: d(m[1]) }),
      load: () => import("./[uid].json-7e254b40.js")
    }
  ]
};
...
const module_lookup = {
  "src/routes/__layout.svelte": () => import("./__layout-6edc117d.js"),
  ".svelte-kit/build/components/error.svelte": () => import("./error-907ac5be.js"),
  "src/routes/index.svelte": () => import("./index-7d9b54bc.js"),
  "src/routes/about.svelte": () => import("./about-26150d82.js"),
  "src/routes/todos/index.svelte": () => import("./index-d7eba842.js")
};
...
export { add_attribute as a, safe_not_equal as b, create_ssr_component as c, now as d, escape as e, each as f, getContext as g, init as i, loop as l, noop as n, render as r, subscribe as s, validate_component as v };
